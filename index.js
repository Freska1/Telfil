...
const token = "";//حط توكن بوتك هنا
const price = "";//سعر بيع تلفيل بدون تاكس
const owner = "";//أيدي أونر البوت
const recipientid = "";//أيدي ألي يتحولوا الكريدت
const probotid = "282859044593598464";//أيدي بروبوت
const category = "";//أيدي الكاتوجوري ألي ينصنع فيها التكتات
const feedback = "";//أيدي روم الأراء
//__________________________________________________________________________//
...
client.once('ready', async () => {
    ...
    client.user.setPresence({
        activities: [{ name: "By Freska", type: activityType }],
        status: 'online'
    });
